...
from transformers.models.gemma2.modeling_gemma2 import (
    Gemma2DecoderLayer as OldGemmaDecoderLayer, #Gemma2DecoderLayer
    Gemma2ForCausalLM as OldGemmaForCausalLM, #Gemma2ForCasualLM
)
from awq.modules.fused.norm import FasterTransformerRMSNorm


class Gemma2AWQForCausalLM(BaseAWQForCausalLM): #Gemma2AWQForCasualLM
    layer_type = "Gemma2DecoderLayer" #Gemma2DecoderLayer
